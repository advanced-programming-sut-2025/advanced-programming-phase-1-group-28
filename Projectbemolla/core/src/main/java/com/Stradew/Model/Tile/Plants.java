...
public class Plants extends Tile{
    private com.Stradew.Model.Enums.Plants plant;
    private int Stage = 0;
    ...
    public Plants(com.Stradew.Model.Enums.Plants plant) {
    ...
    public com.Stradew.Model.Enums.Plants getPlant() {
        return plant;
    }

    public void setPlant(com.Stradew.Model.Enums.Plants plant) {
        this.plant = plant;
    }
