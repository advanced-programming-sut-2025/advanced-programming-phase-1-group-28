...
public enum Seeds {
    ...
    CarrotSeeds(Plants.CARROT , new Texture("Crops/Carrot_Seeds.png")),
    CauliflowerSeeds(Plants.CAULIFLOWER , new Texture("Crops/Cauliflower_Seeds.png")),
    CoffeeBean(Plants.COFFEE_BEAN , new Texture("Crops/Blueberry_Seeds.png")),
    GarlicSeeds(Plants.GARLIC , new Texture("Crops/Garlic_Seeds.png")),
    BeanStarter(Plants.GREEN_BEAN , new Texture("Crops/Blueberry_Seeds.png")),
    KaleSeeds(Plants.KALE ,new Texture("Crops/Kale_Seeds.png") ),
    ParsnipSeeds(Plants.PARSNIP , new Texture("Crops/Parsnip_Seeds.png")),
    PotatoSeeds(Plants.POTATO , new Texture("Crops/Potato_Seeds.png")),
    RhubarbSeeds(Plants.RHUBARB , new Texture("Crops/Rhubarb_Seeds.png" )),
