...
public enum Tree {
    APRICOT_TREE("Apricot Sapling", "7-7-7-7", 28, Fruits.APRICOT, 1 , new Texture(Gdx.files.internal("Trees/Apricot.png"))),
    CHERRY_TREE("Cherry Sapling", "7-7-7-7", 28, Fruits.CHERRY, 1 , new Texture(Gdx.files.internal("Trees/Cherry.png"))),
    BANANA_TREE("Banana Sapling", "7-7-7-7", 28, Fruits.BANANA, 1 , new Texture(Gdx.files.internal("Trees/Banana.png"))),
    MANGO_TREE("Mango Sapling", "7-7-7-7", 28, Fruits.MANGO, 1 , new Texture(Gdx.files.internal("Trees/Mango.png"))),
    ORANGE_TREE("Orange Sapling", "7-7-7-7", 28, Fruits.ORANGE, 1 , new Texture(Gdx.files.internal("Trees/Orange.png"))),
    PEACH_TREE("Peach Sapling", "7-7-7-7", 28, Fruits.PEACH, 1 , new Texture(Gdx.files.internal("Trees/Peach.png"))),
    APPLE_TREE("Apple Sapling", "7-7-7-7", 28, Fruits.APPLE, 1 , new Texture(Gdx.files.internal("Trees/Apple.png"))),
    POMEGRANATE_TREE("Pomegranate Sapling", "7-7-7-7", 28, Fruits.POMEGRANATE, 1 , new Texture(Gdx.files.internal("Trees/Pomegranate.png"))),
