...
public enum NPC {
    Mamad("mamad" , "mamad" , new ArrayList<String>(Arrays.asList("mamad")) , new ArrayList<Item>(Arrays.asList(new Item(2 , "mamad"))) ,new ArrayList<Quest>(Arrays.asList(new Quest()))),;
